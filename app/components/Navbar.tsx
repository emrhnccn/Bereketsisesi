      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <Link href="/market" className="text-gray-600 hover:text-emerald-600 transition">
              Şişeler
            </Link>
            <Link href="/iletisim" className="text-gray-600 hover:text-emerald-600 transition">
              İletişim
            </Link>
          </div>
          
          <div className="flex items-center space-x-4">
            <Link href="/sepet" className="text-gray-600 hover:text-emerald-600 transition">
              Sepet
            </Link>
